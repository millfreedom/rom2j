 ...
 * Big-endian writer
 * ======================= */
public final class BEWriter implements AutoCloseable ,EndianWriter{
    private final OutputStream out;
    private final byte[] tmp8 = new byte[8];

    public BEWriter(OutputStream out) {
        this.out = out;
    }
    ...
    public void writeI64(long v) throws IOException {
        ByteBuffer.wrap(tmp8).order(ByteOrder.BIG_ENDIAN).putLong(0, v);
        out.write(tmp8, 0, 8);
    }
